# Methodology & Decision Template

*Instructions for Claude: When appending a new entry to the decision_log.md file, use this format. This acts as a formal record for all major project decisions, including data sourcing (e.g., choosing a specific API or public dataset), literature scoping, survey design, indicator selection, econometric modeling, and AI tooling decisions (e.g., skill architecture choices, pipeline redesigns, deprecation of tools).*
